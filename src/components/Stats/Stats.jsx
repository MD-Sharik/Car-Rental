    ...
    <>
      <div className="min-h-[7rem] bg-red-500 text-white min-w-[100vw] sm:min-h-[15rem] sm:min-w-[12rem] p-6 opacity-95 sm:bg-zinc-100 sm:text-black rounded-lg shadow-md">
        <ul className="flex items-center flex-wrap gap-4 p-1 sm:block">
          ...
          <li>
            <button className="bg-white  text-red-600 font-medium shadow-zinc-300 sm:bg-red-600 shadow-md sm:shadow-red-400 hover:shadow-lg hover:shadow-red-400 transition-all hover:scale-105 px-5 py-2 rounded-md sm:text-white">
              Rent Now
            </button>
          </li>
        </ul>
