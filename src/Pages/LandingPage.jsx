  ...
  return (
    <>
      <div className="relative ">
        ...
        {/* Block 4 */}
        <div className="bg-red-600 w-full mt-32 shadow-md text-white text-center p-14 shadow-red-200">
        ...
        <div className="m-auto flex flex-col items-center">
          ...
          <div className="flex justify-between m-auto px-11 py-6 gap-11 mt-8 mb-8 bg-zinc-50">
            <div>
              <div>
