          ...
          <div className="block text-center smd:text-left smd:flex justify-between m-auto px-11 py-6 gap-11 mt-8 mb-8 ">
            <div>
              <div>
                ...
                <p className="w-full text-justify smd:max-w-[72ch] my-2">
              ...
              <button className="bg-red-600 my-10 text-white px-[1.8rem] font-medium py-[0.5rem] rounded-sm shadow-lg shadow-red-200">
                <Link to="/about">Learn more</Link>
              </button>
            </div>
            <div className="my-16 text-justify smd:text-left">
              <div className="flex flex-col items-center smd:flex max-w-[70ch]">
                <div>
                  <img
              ...
              <div className=" flex-col items-center smd:flex max-w-[70ch]">
                <div>
                  <img
